...
public class SyncSmsService extends Service {
    ...
    public void onCreate() {
       ...
       if(isNetworkAvailable()) {
           smsNotifier.notify(this, "Updating Sms To Server", "Internet Should Remain Active",
                   R.drawable.ic_verified_user_white_24dp, 1, 20, 100);

           postData.syncSentMessages(0);
       }else {
